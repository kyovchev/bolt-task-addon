...
int OP180_1_State = -1;  // left bolt hole (0 - no bolt, 1 - bolt inserted)
int OP180_2_State = -1;  // right bolt hole (0 - no bolt, 1 - bolt inserted)

float prev_weight_State = 0;
int prev_OP180_1_State = -1;
int prev_OP180_2_State = -1;
...
void updateDisplay() {
  ...
  if (prev_weight_State != weight_State || OP180_1_State != prev_OP180_1_State || OP180_2_State != prev_OP180_2_State) {
...
void loop() {
  ...
  Serial.println(OP180_1_State);
  Serial.println(OP180_2_State);
